...
| merge two accounts results in wrong calculations                                                                                                                             | 1- open App<br/> 2- create account A with balance 900<br/> 3- create account B with balance 99<br/> 4- merge account A to account B                                                                           | video                                                               | device : samsung A52<br/> android :12 | - wifi <br/>- cellular data | high     | high     | high impact in functionality, and UX |
